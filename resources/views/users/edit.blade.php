...
@section('content')
    ...
    <form action="{{ route('users.update', $user) }}" method="POST" class="max-w-md space-y-4">
        ...
        <div>
            ...
            <p class="text-xs text-slate-500 dark:text-slate-400 mb-2">When this user is an Editor: only job items in selected categories can be edited by them. Leave all unchecked = can edit items in any category.</p>
